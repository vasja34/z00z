...
| `E09` | `065-09` final narrowed-claim source sweep | `.planning/codebase/STRUCTURE.md:134-135`<br>`.planning/codebase/ARCHITECTURE.md:221`<br>`crates/z00z_storage/src/settlement/root_types.md:86-89`<br>`scripts/audit/audit_narrowed_wording.sh`<br>`crates/z00z_core/tests/test_live_guardrails.rs:38,310` | `bash scripts/audit/audit_narrowed_wording.sh`<br>`cargo test --release -p z00z_core --test test_live_guardrails -- --nocapture`<br>`cargo test --release` |
