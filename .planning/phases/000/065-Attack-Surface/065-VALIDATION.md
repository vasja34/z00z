...
| `065-T09` | `09` | `T9` | `WS-09` | `P09-T1..P09-T3` | Narrowed historical leftovers stay retired across docs, planning artifacts, and live guardrails | source-audit + guardrail | `bash scripts/audit/audit_narrowed_wording.sh`<br>`cargo test --release -p z00z_core --test test_live_guardrails -- --nocapture`<br>`cargo test --release` | ✅ | ✅ green |
