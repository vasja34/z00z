...
- `.github/skills/pentest-tools-installer/references/hexstrike/`
...
- `git diff --check -- .github/skills/pentest-local-orchestrator/references .github/skills/pentest-tools-installer/references tools/penetration/manifests/upstream-sources.lock`
- `rg -n "FIXME|panic!\\(|unimplemented!\\(|todo!\\(" .github/skills/pentest-local-orchestrator/references .github/skills/pentest-tools-installer/references tools/penetration/manifests/upstream-sources.lock`
- `rg -n "\\bTODO\\b" .github/skills/pentest-local-orchestrator/references .github/skills/pentest-tools-installer/references tools/penetration/manifests/upstream-sources.lock | rg -v "066-TODO\\.md"`
