...
`reports/z00z-pentests-report-<timestamp>/` for host-facing pentest exports.
...
- Generic skill family
  - Added `pentest-local-orchestrator`, `pentest-source-aware-sast`,
    ...
    roots.
  - Updated `pentest-tools-installer` to align with the same path, artifact,
...
- Pass 1
  - Re-read `066-04-PLAN.md`, `066-TODO.md`, `066-CONTEXT.md`,
    `pentest-tools-installer/SKILL.md`, `attack-surfaces-create/SKILL.md`, and
