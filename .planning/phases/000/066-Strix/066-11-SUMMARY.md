...
`./scripts/run_pentest_tools.sh`; the Docker lane remains optional, archive-driven,
...
`reports/z00z-pentests-report-<timestamp>/` roots.
...
- Regression coverage
  ...
  - `scripts/run_pentest_tools.sh` help text now states that the Docker lane never
...
- `bash -n scripts/run_pentest_tools.sh tools/penetration/docker/run_pentest_container.sh unpack_z00z_project.sh pack_z00z_project.sh scripts/penetration/check_pentest_tools.sh`
...
- `./scripts/run_pentest_tools.sh --mode quick --static-only --check-only --artifact-dir /tmp/z00z-pentest-local-check-ws11`
...
- `./scripts/run_pentest_tools.sh --docker-sandbox --mode quick --static-only --check-only`
- `docker build -t z00z-pentest:local -f tools/penetration/docker/Dockerfile tools/penetration/docker`
- `./scripts/run_pentest_tools.sh --docker-sandbox --docker-image z00z-pentest:local --archive /tmp/z00z-pentest-ws11.tar.gz --mode quick --static-only --check-only`
- `git diff --check`
