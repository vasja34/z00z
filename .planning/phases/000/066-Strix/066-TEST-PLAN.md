...
- Unit and contract tests are authoritative for validators, manifests, report
  classification, source-aware SAST runner behavior, prompt contracts, profile
  routing, and Docker scope guards.
...
- Source-aware SAST structural-tool status and secrets artifacts must be
  recorded truthfully.
