...
- Skill surface
  - Added `.github/skills/pentest-tools-installer/SKILL.md` that calls the
...
- `git diff --check -- tools/penetration scripts/penetration .github/skills/pentest-tools-installer/SKILL.md .planning/STATE.md .planning/ROADMAP.md`
- `rg -n "TODO|FIXME|panic!\\(|unimplemented!\\(|todo!\\(" tools/penetration scripts/penetration .github/skills/pentest-tools-installer/SKILL.md`
