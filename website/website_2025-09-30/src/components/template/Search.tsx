        ...
        <Link href={url} onClick={onNavigate}>
            <div
                className={classNames(
                    'flex flex-wrap items-center justify-between rounded-xl p-3 cursor-pointer user-select',
                    'hover:bg-search-item-hover-background',
                )}
            >
                <div className="flex items-center gap-2">
                    ...
                    <div className="text-search-item-hover-text font-semibold">
                        <Highlighter
                            autoEscape
                ...
                <div className="w-full pt-2.5 opacity-60 [&>*]:text-xs space-y-1">
                    <Markdown
...
const _Search = ({ className }: { className?: string }) => {
    ...
    return (
        <>
            ...
            >
                <div>
                    <div className="px-4 flex items-center justify-between border-b border-search-dialog-border">
                        <div className="flex items-center">
                            <HiOutlineSearch className="text-xl" />
                            <input
                                ref={inputRef}
                                className="ring-0 outline-hidden block w-full p-4 text-base bg-transparent text-search-dialog-text"
                                placeholder="Search..."
