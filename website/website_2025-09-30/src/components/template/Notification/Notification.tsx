    ...
    return (
        ...
        >
            <Dropdown.Item variant="header">
                <div className="border-notification-item-background-border px-2 flex items-center justify-between mb-1">
                    <h6>Notifications</h6>
            ...
            >
                {notificationList.length > 0 &&
                    notificationList.map((item, index) => (
                        <div key={item.id}>
                            <div
                                className={`relative rounded-xl flex px-4 py-3 cursor-pointer hover:bg-notification-item-background-hover active:bg-notification-item-background-active`}
                            ...
                            >
                                ...
                                <Badge
                                    ...
                                    innerClass={`${
                                        item.readed
                                            ? 'bg-notification-item-badge-background-readed'
                                            : 'bg-primary'
                                    } `}
                                />
                            </div>
