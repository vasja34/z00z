...
const Button = (props: ButtonProps) => {
    ...
    const defaultColor = () => {
        const btn = {
            bgColor: active
                ? `bg-button-default-background border border-button-default-border`
                : `bg-button-default-background border border-button-default-active-border`,
            textColor: `text-button-default-text`,
            hoverColor: active
                ? ''
