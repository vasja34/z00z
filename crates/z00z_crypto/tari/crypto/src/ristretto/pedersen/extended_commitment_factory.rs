...
use crate::{
    ...
    commitment::{
        ExtendedHomomorphicCommitmentFactory, ExtensionDegree, HomomorphicCommitment, HomomorphicCommitmentFactory,
    },
    errors::CommitmentError,
    ristretto::{
        constants::{ristretto_nums_points, RISTRETTO_NUMS_POINTS_COMPRESSED},
        pedersen::{
            ristretto_pedersen_h, ristretto_pedersen_h_compressed, PedersenCommitment, RISTRETTO_PEDERSEN_G,
    ...
    use crate::{
        ...
        ristretto::{
            ...
            pedersen::{
                ...
                extended_commitment_factory::ExtendedPedersenCommitmentFactory, ristretto_pedersen_h,
