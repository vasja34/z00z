...
use digest::{
    consts::{U32, U64},
    Digest, FixedOutput, FixedOutputReset, Output, OutputSizeUser, Update,
};
use sha3::Sha3_256;
...
mod test {
    ...
    use crate::hashing::{
        byte_to_decimal_ascii_bytes, AsFixedBytes, DomainSeparatedHasher, DomainSeparation, Mac, MacDomain,
    };
