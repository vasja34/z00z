...
- Codex plugin installs expose skills. They do not register repository-shared
  `/deep-wiki:*` slash hints.
- Codex slash commands come from per-user `~/.codex/prompts/*.md` files.
