...
Target artifact: `.planning/phases/072-Offline-Transaction/072-Offline-Transaction-Spec-Fusion.md`

Companion audit: `.planning/phases/072-Offline-Transaction/072-Offline-Transaction-Spec-Fusion.audit.md`
...
- The companion audit MUST prove that no source section or material requirement was lost during fusion.
...
| --- | --- | --- |
| Document | `072-Offline-Transaction-Spec-Fusion` | Canonical Phase 072 fusion spec. |
...
| What prior material is superseded? | Section 2 and the companion audit |
...
offline_transaction:
  meta:
    ...
    source_spec: ".planning/phases/072-Offline-Transaction/072-Offline-Transaction-Spec-Fusion.md"
    audit_spec: ".planning/phases/072-Offline-Transaction/072-Offline-Transaction-Spec-Fusion.audit.md"
...
This document is self-contained for implementation, review, test planning, and architecture audit. The companion audit preserves the one-time deletion and coverage record; implementation work SHOULD use this document rather than retired drafts.
