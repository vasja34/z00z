...
<required_reading>
@~/.copilot/get-shit-done/references/domain-probes.md
@~/.copilot/get-shit-done/references/gate-prompts.md
@~/.copilot/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @~/.copilot/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
SPIKE_FINDINGS=$(ls ./.github/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1)
SKETCH_FINDINGS=$(ls ./.github/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1)
...
```bash
PROFILE_CONTENT=$(cat "$HOME/.copilot/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
**Full step-by-step instructions:** @~/.copilot/get-shit-done/workflows/discuss-phase-power.md
